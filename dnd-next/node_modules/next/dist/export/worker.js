...
const _ismissingpostponeerror = require("../server/app-render/is-missing-postpone-error");
...
async function exportPageImpl(input, fileWriter) {
    ...
    try {
        ...
        const incrementalCache = isAppDir && fetchCache ? (0, _createincrementalcache.createIncrementalCache)(incrementalCacheHandlerPath, isrMemoryCacheSize, fetchCacheKeyPrefix, distDir, dir, enabledDirectories, // PPR is not available for Pages.
        {
            ppr: false
        }) : undefined;
        // Handle App Routes.
        ...
        if (isAppDir) {
            ...
            return await (0, _apppage.exportAppPage)(req, res, page, path, pathname, query, renderOpts, htmlFilepath, debugOutput, isDynamicError, isAppPrefetch, fileWriter);
        }
        ...
        if (!(0, _ismissingpostponeerror.isMissingPostponeDataError)(err)) {
