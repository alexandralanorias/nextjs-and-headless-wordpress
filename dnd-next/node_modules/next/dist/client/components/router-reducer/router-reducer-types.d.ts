...
import type { FlightRouterState, FlightData, FlightSegmentPath } from '../../../server/app-render/types';
...
export type RouterChangeByServerResponse = (previousTree: FlightRouterState, flightData: FlightData, overrideCanonicalUrl: URL | undefined) => void;
export type RouterNavigate = (href: string, navigateType: 'push' | 'replace', forceOptimisticNavigation: boolean, shouldScroll: boolean) => void;
...
export type ThenableRecord<T> = PendingThenable<T> | RejectedThenable<T> | FulfilledThenable<T>;
