...
import { createEntrypoints, createPagesMapping, finalizeEntrypoint, getClientEntry, getEdgeServerEntry, getAppEntry, runDependingOnPageType, getStaticInfoIncludingLayouts } from "../../build/entries";
...
import { difference, isMiddlewareFile, isMiddlewareFilename } from "../../build/utils";
...
export default class HotReloader {
    ...
    async start() {
                ...
                await Promise.all(Object.keys(entries).map(async (entryKey)=>{
                    ...
                    runDependingOnPageType({
                        ...
                        onServer: ()=>{
                            ...
                            } else if (!isMiddlewareFile(page) && !isInternalComponent(relativeRequest) && !isNonRoutePagesPage(page)) {
                                value = getRouteLoaderEntry({
        ...
        this.multiCompiler = webpack(this.activeWebpackConfigs);
    ...
    invalidate({ reloadAfterInvalidation } = {
        ...
        const outputPath = (_this_multiCompiler = this.multiCompiler) == null ? void 0 : _this_multiCompiler.outputPath;
        return outputPath && ((_getInvalidator = getInvalidator(outputPath)) == null ? void 0 : _getInvalidator.invalidate());
    }
    async stop() {
        await new Promise((resolve, reject)=>{
