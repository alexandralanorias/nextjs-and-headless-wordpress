...
function processZodErrorMessage(issue) {
    ...
    if (issue.code === "invalid_enum_value") {
        ...
        return `Expected ${ZodUtil.joinValues(issue.options)}, received '${issue.received}' at ${path}`;
    }
...
function assignDefaults(dir, userConfig, silent) {
    var _result_experimental, _result_experimental1, _result_experimental2, _result_experimental_serverActions, _result_experimental3, _result_experimental4, _result_experimental5, _result_experimental6, _result_experimental7, _result_devIndicators, _result_experimental8;
    ...
    if (((_result_experimental = result.experimental) == null ? void 0 : _result_experimental.ppr) && !"14.0.2".includes("canary") && !process.env.__NEXT_TEST_MODE) {
    ...
    if (typeof ((_result_experimental2 = result.experimental) == null ? void 0 : _result_experimental2.serverActions) === "boolean") {
    ...
    if (typeof ((_result_experimental3 = result.experimental) == null ? void 0 : (_result_experimental_serverActions = _result_experimental3.serverActions) == null ? void 0 : _result_experimental_serverActions.bodySizeLimit) !== "undefined") {
        ...
        if (isNaN(value) || value < 1) {
            throw new Error("Server Actions Size Limit must be a valid number or filesize format lager than 1MB: https://nextjs.org/docs/app/api-reference/functions/server-actions#size-limitation");
        }
    }
    ...
    if (((_result_experimental4 = result.experimental) == null ? void 0 : _result_experimental4.outputFileTracingRoot) && !isAbsolute(result.experimental.outputFileTracingRoot)) {
    ...
    if ((_result_experimental6 = result.experimental) == null ? void 0 : _result_experimental6.useDeploymentIdServerActions) {
        result.experimental.useDeploymentId = true;
    }
    // use the closest lockfile as tracing root
    if (!((_result_experimental7 = result.experimental) == null ? void 0 : _result_experimental7.outputFileTracingRoot)) {
    ...
    const userProvidedOptimizePackageImports = ((_result_experimental8 = result.experimental) == null ? void 0 : _result_experimental8.optimizePackageImports) || [];
    if (!result.experimental) {
        result.experimental = {};
    }
