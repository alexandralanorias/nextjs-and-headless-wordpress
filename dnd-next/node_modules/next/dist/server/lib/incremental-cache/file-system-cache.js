        ...
        if (!data && process.env.NEXT_RUNTIME !== "edge") {
            ...
            try {
                ...
                if (kind === "fetch") {
                    ...
                    const pageData = isAppPath ? await this.fs.readFile(this.getFilePath(`${key}${this.experimental.ppr ? _constants.RSC_PREFETCH_SUFFIX : _constants.RSC_SUFFIX}`, "app"), "utf8") : JSON.parse(await this.fs.readFile(this.getFilePath(`${key}.json`, "pages"), "utf8"));
                    let meta;
                    if (isAppPath) {
                        try {
