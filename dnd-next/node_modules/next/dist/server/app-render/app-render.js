...
async function renderToHTMLOrFlightImpl(req, res, pagePath, query, renderOpts, baseCtx) {
   ...
   */ const params = renderOpts.params ?? {};
    ...
    let stringifiedFlightPayloadPromise = isStaticGeneration ? generateFlight(ctx).then((renderResult)=>renderResult.toUnchunkedString(true)).catch(()=>null) : Promise.resolve(null);
    ...
    const bodyResult = (0, _tracer.getTracer)().wrap(_constants.AppRenderSpan.getBodyResult, {
        ...
        try {
            ...
            if (renderOpts.postponed) {
                return (0, _nodewebstreamshelper.continuePostponedFizzStream)(stream, options);
            }
            return (0, _nodewebstreamshelper.continueFizzStream)(stream, options);
        } catch (err) {
            var _err_message;
    ...
    if (staticGenerationStore.isStaticGeneration) {
        ...
        renderOpts.experimental.ppr && // and a call to `maybePostpone` happened
