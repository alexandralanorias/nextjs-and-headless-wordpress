...
async function getData() {
  ...
  const res = await fetch("http://localhost/dnd-next-wp/wp-json/wp/v2/posts");
  ...
  return (
    <>
      ...
      <div className="container mx-auto py-8">
        <h3 className="text-xl mx-auto my-6 px-16">
          All my posts ({data.length})
        </h3>
        {/* you can delete this line i just wanted to
          ...
          {data.map(
            (value: {
              ...
              return (
                ...
                //   {/* Update: Now working */}
                //   <img>{value["featured_media"]["rendered"]}</img>
